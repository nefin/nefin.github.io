...
author_url: ""
author_photo: ""
author_bio: "Ph.D. candidate in Economics at FEA-USP, advised by Rodrigo De Losso. Writes about research developments and other topics on his digital garden, <a href=\"https://www.cobbdouglaz.com/\" target=\"_blank\" rel=\"noopener\">cobbdouglaz.com</a>."
author_bio_pt: "Doutorando em Economia na FEA-USP, orientado por Rodrigo De Losso. Escreve sobre os desenvolvimentos da pesquisa e outros temas em seu digital garden, o <a href=\"https://www.cobbdouglaz.com/\" target=\"_blank\" rel=\"noopener\">cobbdouglaz.com</a>."
...
market"); α is whatever's left over once market risk is accounted for, and CAPM says it
...
- **R² = 0.65**: the market factor explains 65% of this portfolio's day-to-day variation
...
*idiosyncratic risk*: small, less-liquid firms carry return variation that one market
factor alone doesn't capture, part of it diversifiable, part of it exactly what NEFIN's
own SMB factor exists to price. If you want a next step to try yourself, that comparison,
or adding SMB, HML and WML as extra regressors, is two more lines of `nefin` code away.
...
One standard explanation doesn't require small caps to be genuinely calmer, only harder
to price every single day. Many smaller Brazilian stocks trade less frequently than the
large, liquid names driving the index, so a chunk of their "daily" return is really
yesterday's price catching up today; their measured co-movement with the market gets
diluted simply because some of their price reaction is delayed by a day or more. This is
an old, well-documented issue (Scholes and Williams, 1977; Dimson, 1979), and the
standard fix is to regress on lagged and lead market returns too, not just today's. That's
a step a five-line teaching regression skips on purpose. It's also consistent with the
lower R² we found earlier: some of what looks like "idiosyncratic" variation in the
...
mercado"); α é o que sobra depois de descontar esse risco de mercado, e o CAPM diz que
...
contra o retorno de mercado defasado e adiantado, não só o de hoje. Isso é algo que uma
